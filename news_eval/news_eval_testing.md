...
<html>
  ...
  <body>
    ...
    <ol>
      ...
      <li class="guide-inline-hidden">Type and submit question 1, wait for the response to fully render, then type and submit question 2, and wait for that response to fully render.</li>
      <li class="guide-inline-hidden">Type and submit question 3. While waiting for its response, type question 4 so it is ready to submit as soon as the input field becomes available.</li>
    </ol>
